...
# American Honors
	Blog.create(filename: 'nathan_maton_american_honors.png', caption: 'American Honors', isfeatured: false , subcaption: 'Lead Producer & Developer', full_img1: 'nathan_maton_american_honors_full.png', full_img2: 'nathan_maton_american_honors_full2.png', full_title: 'American Honors', full_body: 'Led the online marketing team, to help manage the design and development for their program and corporate websites.  <br><br> I helped on many aspects of the website\'s development, coding several features.')
# Operation Hire Me
