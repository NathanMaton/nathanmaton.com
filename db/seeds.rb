...
#	American Honors
	Blog.create(filename: 'nathan_maton_american_honors.png', caption: 'Lead Producer & Developer', isfeatured: false , subcaption: 'Visual Communication', full_img1: 'nathan_maton_american_honors_full.png', full_img2: 'nathan_maton_american_honors_full2.png', full_title: 'American Honors Websites', full_body: 'Lead site design and helped on developing the American Honors corporate website.')
#Operation Hire Me
	Blog.create(filename: 'nathan_maton_operation_hire_me.png', caption: 'Learning Designer & Developer', isfeatured: false , subcaption: 'Learning Design', full_img1: 'nathan_maton_operation_hire_me_full1.png', full_img2: 'nathan_maton_operation_hire_me_full2.png', full_title: 'Operation Hire Me', full_body: 'Designed to help forming good job seeking habits and train job seekers in interviewing softskills Operation Hire Me is a prototype learning game.  Try it <a href="http://ophireme.herokuapp.com/"> here </a>.')
# Pandora's blocks
	Blog.create(filename: 'nathan_maton_pandoras_blocks.png', caption: 'Game Designer & Developer', isfeatured: false , subcaption: 'Game', full_img1: 'nathan_maton_pandoras_blocks_full.png', full_img2: 'nathan_maton_pandoras_blocks_full2.png', full_title: 'Pandora\'s Blocks', full_body: 'The community pick winner of the GMU Global Game Jam, Pandora\'s Blocks is best described as 3D Go.  It is an online multiplayer game.  <a href="http://martinwsmith.com/pandorasblocks/">Click here</a> to play.')
#BVW
	Blog.create(filename: 'nathan_maton_bvw.png', caption: 'Developer', isfeatured: false , subcaption: 'Game', full_img1: 'nathan_maton_bvw_full.png', full_img2: '', full_title: 'Beans vs. Waffles', full_body: 'Beans vs. Waffles is a iPad game I helped design and develop that pits two nations against eachother.  <a href="http://itunes.apple.com/us/app/beans-vs.-waffles-space-wizards/id470426832?mt=8"> Download it free.</a>')
#Get a Clue
